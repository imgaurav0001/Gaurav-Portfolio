  ...
  return (
    <div className="page-shell min-h-screen text-slate-100">
      <main className="mx-auto max-w-6xl px-4 pb-16 pt-10 md:px-8 md:pb-24 md:pt-16">
        <header
          data-reveal
          className="z-20 mb-10 flex w-full flex-col items-center gap-4 rounded-3xl border border-white/10 bg-slate-900/70 px-5 py-4 text-center backdrop-blur-xl lg:sticky lg:top-6 lg:flex-row lg:justify-between lg:rounded-full lg:text-left"
        >
